    ...
    <div className="navbar">
      <div className="container">
        <ul className="navlinks">
          ...
          {loc === "/Body" ? "" : <Link to="/Body">About</Link>}

          {loc === "/Skills" ? "" : <Link to="/Skills">Skills</Link>}
          {loc === "/Education" ? "" : <Link to="/Education">Education</Link>}
          {loc === "/Services" ? "" : <Link to="/Services">Contact</Link>}
        </ul>
        ...
        <>
          <div id="mySidebar" className="sidebar">
            ...
            <ul>
              ...
              <li>
                <Link to="/Body" onClick={() => hamburger(false)}>
                  About
                </Link>
              </li>
              ...
              <li>
                <Link to="/Services" onClick={() => hamburger(false)}>
                  Contact
                </Link>
              </li>
            </ul>
